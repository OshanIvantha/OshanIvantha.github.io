...
export default [
    {
        date: "Apr 17, 2022",
        content: <>Started working towards an improved Sinhala OCR solution with {people.indrajithekanayake.anchor}.</>
    },
    {
        date: "May 01, 2021",
    ...
    {
        date: "Sep 29, 2020",
        content: <>I joined {orgs.score.anchor} to work on a research to find ways to match internet domain entities using ML techniques with {people.mohammadnabeel.anchorithhonorifics} @{orgs.qcri.anchor}.</>
    },
    {
        date: "Jul 01, 2018",
        content: <>I joined {orgs.ucsc.anchor} as a full-time Research Intern to work under the topic 'Machine Learning over Encrypted Data'. I will be supervised by {people.nalinranasinghe.anchorithhonorifics}.</>
    },
    {
        date: "Jan 18, 2018",
        content: <>I started working part-time on developing an OCR solution for Sinhala language using Tesseract OCR Engine in collaboration with {people.leoniesolomons.anchorithhonorifics}.</>
    },
    {
        date: "Feb 05, 2016",
