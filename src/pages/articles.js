                    ...
                    <li className="articles-wrapper">
                        <div className="articles-card">
                            ...
                            <div className="card-content">
                                ...
                                <span className="content-text">If you are here, chances are you know what CORS is. But let’s go through the basics in case you are a bit rusty on the exact way that CORS works. You can hop over to the next section if you feel confident...</span><br />
                    ...
                    <li className="articles-wrapper">
                        <div className="articles-card">
                            ...
                            <div className="card-content">
                                ...
                                <span className="content-text">Google Summer of Code is an annual initiative carried out by Google for the betterment of the open-source software and the students in STEM fields. It started in 2005 as a program that would help students...</span><br />
