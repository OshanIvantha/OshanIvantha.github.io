            ...
            <div className="section-items">
                <ul>
                    <li>
                        ...
                        <br/>
                        <span><a className="link" href="/2021_kmatrix_a_space_efficient_streaming_graph_summarization_technique.pdf" target="_blank" rel="noopener noreferrer">[PDF]</a></span>
                    </li>
                </ul>
            </div>
        </div>
